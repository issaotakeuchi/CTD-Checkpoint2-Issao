  ...
  return (
    <footer className={theme === 'light' ? `light` : `dark`}>
      <div className={styles.footerWrapper}>
        ...
        <div className={theme === 'light' ? `navbar-light bg-light ${styles.footer}` : `navbar-light bg-dark ${styles.footer}`}>
          <div className="container">
            <div className={`row`}>
              <div className="col-sm-12 col-lg-6">
                {/* //Na linha seguinte deverá ser feito um teste se a aplicação
                // está em dark mode e deverá utilizar o css correto */}
                <img className={theme === 'light' ? `${styles.dhLogo}` : `${styles.dhLogo} ${styles.iconsDark}`} src="/images/DH.png" alt='DH-logo' />
              </div>
              <div className={theme === 'light' ? `col-sm-12 col-lg-6 ${styles.icons}` : `col-sm-12 col-lg-6 ${styles.icons} ${styles.iconsDark}`}>
